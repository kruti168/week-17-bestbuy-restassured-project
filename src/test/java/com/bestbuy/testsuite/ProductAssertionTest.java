...
public class ProductAssertionTest {
    ...
    @Test
    public void verifyMultipleProductNames() {
...
//            List<Integer> price = response.equalTo("Household Batteries");
    //        System.out.println("The names of products that price is less than 4.99 are: " + price);

            response.body("data[3].price",is(4.99f));
        }
        //8. Verify the Product name = Duracell - D Batteries (4-Pack) of 6th product
    @Test
    public void productDuracell(){
